...
![UML Sequence Diagram for generateWeekSummaryReport()](diagrams/weekly%20report.drawio.png)
The following sequence diagram describes the operation of the `generateMonthSummary()` method.
![UML Sequence Diagram for generateMonthSummaryReport()](diagrams/monthly%20report.drawio.png)
## Storage
