...
4. Type the following command in your terminal to run this program: <br/>
⚠️for Mac/Linux user `java -jar FitNus.jar` <br/>
⚠️for Windows user: `java -DFile.Encoding=UTF-8 -jar FitNus.jar`
